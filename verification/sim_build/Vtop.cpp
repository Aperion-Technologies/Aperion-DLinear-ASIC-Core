...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , io_dataValid{vlSymsp->TOP.io_dataValid}
    , io_predValid{vlSymsp->TOP.io_predValid}
    , io_configMode{vlSymsp->TOP.io_configMode}
    , io_config_addr{vlSymsp->TOP.io_config_addr}
    , io_config_data{vlSymsp->TOP.io_config_data}
    , io_config_writeEn{vlSymsp->TOP.io_config_writeEn}
    , io_config_weightSel{vlSymsp->TOP.io_config_weightSel}
    , io_status_ready{vlSymsp->TOP.io_status_ready}
    , io_status_weightsLoaded{vlSymsp->TOP.io_status_weightsLoaded}
    , io_predOut{vlSymsp->TOP.io_predOut}
    , rootp{&(vlSymsp->TOP)}
{
